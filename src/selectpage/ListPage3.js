...
import ListPageChild3 from "./ListPageChild3";
import {Pagination,Input,Segment} from "semantic-ui-react";
require('./ListPage.css')

class ListPage3 extends React.Component{
    ...
    render(){
        ...
        return(
            <div id='in_page1'>
                ...
                <h1 id= "list_page_h1">健康档案列表</h1>
                <div id="list_page_div1">
                    <div id="list_page_div2">
                        <Segment secondary id='list_page_seg1'>
                            <ListPageChild3 key={this.state.key} activePage={this.state.activePage}/>
